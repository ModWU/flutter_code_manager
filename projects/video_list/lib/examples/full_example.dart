        ...
        builder: (context) {
          return DefaultTabController(
            ...
            child: Scaffold(
              ...
              appBar: AppBar(
                title: const Text('Video player full example'),
                actions : <Widget>[
                  IconButton(
          ...
          child: Column(
            children: <Widget>[
              ...
              Stack(
                ...
                children: <Widget>[
                  _ButterFlyAssetVideo(),
                  Image.asset('assets/flutter-mark-aquare-64.png'),
                ],
              ),
            ],
          ),
...
class _ButterFlyAssetVideo extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _ButterFlyAssetVideoState();
}
...
class _BumbleBeeRemoteVideo extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _BumbleBeeRemoteVideoState();
}
...
class _PlayerVideoAndPopPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _PlayerVideoAndPopPageState();
}
